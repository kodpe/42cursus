...
/*   Updated: 2023/01/08 17:49:23 by sloquet          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	{
		...
		std::cout << b.getType() << " : "; b.makeSound();
		std::cout << c.getType() << " : "; c.makeSound();
		std::cout << d->getType() << " : "; d->makeSound();
	...
	{
		LOG_TITLE("WrongAnimal + WrongCat TEST")
